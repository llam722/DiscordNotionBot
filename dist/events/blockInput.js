...
module.exports = {
    ...
    async execute(interaction) {
        if (interaction.customId === "blockInput") {
            ...
            const blockHeader = interaction.fields.getTextInputValue("blockHeaderInput");
            const blockContent = interaction.fields.getTextInputValue("blockContentInput");
        ...
        async function addItem(blockHeader, blockContent) {
            ...
            if (!blockId)
                return await interaction.reply('No page selected. Please select a page using "/selectpage" before using this command.');
